...
What I also like is being able to directly use all different editing features
inside of
...
longer outputs into their own dedicated buffers, possibly displaying
them in a second window.
